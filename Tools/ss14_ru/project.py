...
class Project:
    def __init__(self):
        ...
        self.en_locale_prototypes_dir_path = os.path.join(self.en_locale_dir_path, '', 'prototypes')
        self.ru_locale_prototypes_dir_path = os.path.join(self.ru_locale_dir_path, '', 'prototypes')
